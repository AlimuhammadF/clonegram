			...
			<div className="w-full max-w-sm p-6 m-auto bg-white rounded-lg shadow-xl py-10">
				<form className="mt-6">
					<div>
						...
						<input
							type="text"
							className="block w-full px-4 py-2 mt-2  bg-white border rounded-md  text-gray-800 border-gray-600  focus:border-violet-300 focus:ring-violet-300 focus:outline-none focus:ring focus:ring-opacity-40"
						/>
					</div>

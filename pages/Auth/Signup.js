...
export default function Signup() {
	...
	return (
		<div className="my-28 px-5">
			<div className="w-full max-w-sm p-6 m-auto bg-white rounded-lg shadow-xl py-10">
				<form className="mt-6">
					<div>
						<label
							htmlFor="username"
						...
						<input
							type="text"
							className="block w-full px-4 py-2 mt-2  bg-white border rounded-md  text-gray-800 border-gray-600 focus:border-violet-400 focus:border-violet-300 focus:ring-violet-300 focus:outline-none focus:ring focus:ring-opacity-40"
						/>
					</div>
					...
					<div className="mt-4">
						...
						<input
							type="password"
							className="block w-full px-4 py-2 mt-2  bg-white border rounded-md  text-gray-800 border-gray-600 focus:border-violet-400 focus:ring-violet-300 focus:outline-none focus:ring focus:ring-opacity-40"
						/>
					</div>
					...
					<div className="mt-6">
						<button className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-violet-700 rounded-md hover:bg-violet-500 focus:outline-none focus:bg-violet-500">
							Signup
						</button>
					</div>
				</form>
